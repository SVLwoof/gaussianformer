...
train_c2w = cams(500, seed=21, radii=(1.05, 2.55))
troot = Path("experiments/overfit/data/tomatoes_codec2")
...
with h5py.File(troot/"h5s"/"tomatoes_codec2.h5", "w") as f:
...
render_set(train_c2w, troot/"renders", "tomatoes_codec2")
print(f"train: 500 randomized views (r 1.05-2.55) -> {troot}")
