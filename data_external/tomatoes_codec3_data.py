...
train_c2w = cams(1500, seed=31, radii=(1.05, 2.55))
troot = Path("experiments/overfit/data/tomatoes_codec3")
...
with h5py.File(troot/"h5s"/"tomatoes_codec3.h5", "w") as f:
...
render_set(train_c2w, troot/"renders", "tomatoes_codec3")
print(f"train: 1500 randomized views (r 1.05-2.55) -> {troot}")

print("v2 datagen done")
