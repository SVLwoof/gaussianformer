...
# debian13 nodes (reservation 5787: firefoot-01, khan-01): isolated venv + caches, driver libs in
# /etc/lib64/nvidia (stale ld.so.cache), nvidia-smi absent -> arch via torch.
EXT_TAG=
