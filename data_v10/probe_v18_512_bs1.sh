...
#SBATCH -c 32
#SBATCH --mem=200GB
#SBATCH --output=runs/probe_v18_512_bs1_%j.out
#SBATCH --job-name=gformer_probe512b1
#SBATCH --gres=gg:g4:4
#SBATCH --killable
#SBATCH --requeue
#SBATCH --exclude=khan-01,khan-02,cyril-01

# VRAM probe for V18 stage B: does --batch_size 1 --resolution 512 WITH LPIPS fit?
#
...
#
#   sbatch data_v10/probe_v18_512_bs1.sh
