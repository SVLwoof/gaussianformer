...
#SBATCH -c 16
#SBATCH --mem=64GB
#SBATCH --output=runs/nsweep_ctrl100_%j.out
#SBATCH --job-name=nswctrl100
#SBATCH --gres=gg:g4:4
...
#   sbatch data_v10/train_nsweep_ctrl100.sh
...
SAVE=checkpoints_nsweep_n100_ctrl
EPOCHS=300      # 100 scenes x 4 views / 4 ranks = 100 steps/epoch -> 30k steps, same as sweep
echo "CTRL100: aug=OFF wd=0 | 4 GPUs, $EPOCHS epochs, node=$(hostname) sm_${ARCH}"
