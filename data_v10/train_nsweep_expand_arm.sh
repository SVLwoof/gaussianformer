...
ENC=${ENC:?}
VIEW=${VIEW:?}
SEED=checkpoints_depthexpand/init_e${ENC}v${VIEW}.pt
SAVE=checkpoints_nsweep_n100_expand_e${ENC}v${VIEW}
echo "EXPAND ARM e${ENC}v${VIEW} | 4 GPUs, 300 epochs | node=$(hostname) sm_${ARCH}"
