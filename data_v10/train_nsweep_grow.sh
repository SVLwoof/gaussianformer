...
GROW=${GROW:?ffn8|inmlp}
EXTRA_ARGS=${EXTRA_ARGS:?}
SEED=checkpoints_depthexpand/init_${GROW}.pt
SAVE=checkpoints_nsweep_n100_grow_${GROW}
echo "GROW ARM ${GROW} (${EXTRA_ARGS}) | 4 GPUs, 300 epochs | node=$(hostname) sm_${ARCH}"
