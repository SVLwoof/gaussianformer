...
if [ "$ARM" = "objav" ]; then
  ...
  GH5=experiments/overfit/data/tomatoes_rec/h5s; REN=experiments/overfit/data/tomatoes_rec/renders
fi
SEED=checkpoints_v18_256/phase2_epoch_30.pt
SAVE=checkpoints_nsweep_n1_${ARM}_rec
EPOCHS=30000; SAVE_INT=2000
