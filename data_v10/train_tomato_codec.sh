...
if [ "$ARM" = "objav" ]; then
  ...
  GH5=experiments/overfit/data/tomatoes_codec/h5s; REN=experiments/overfit/data/tomatoes_codec/renders
fi
SEED=checkpoints_v18_256/phase2_epoch_30.pt
SAVE=checkpoints_tomato_codec
EPOCHS=600; SAVE_INT=40
