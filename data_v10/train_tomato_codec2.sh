...
if [ "$ARM" = "objav" ]; then
  ...
  GH5=experiments/overfit/data/tomatoes_codec2/h5s; REN=experiments/overfit/data/tomatoes_codec2/renders
fi
SEED=checkpoints_v18_256/phase2_epoch_30.pt
SAVE=checkpoints_tomato_codec2
EPOCHS=240; SAVE_INT=16
