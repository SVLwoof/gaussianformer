...
#SBATCH -c 8
#SBATCH --mem=48GB
#SBATCH --output=runs/eval_v14aug_n20k_%j.out
#SBATCH --job-name=eval_v14aug
#SBATCH --gres=gg:g4:1
#SBATCH --killable
#SBATCH --requeue
...
#
#   sbatch runs/eval_v14aug_n20k.sh
...
uv run --frozen python -m eval_val_full \
  --checkpoint checkpoints_v14_aug/phase2_epoch_20.pt \
  --pe_type rope \
  --h5_dir data_v9_n20k/h5s_val \
  --gt_dir data_v9/renders_val \
  --out_json eval_results/v14aug_ep20_n20k_val.json \
  --resolution 512 \
  --tone_mapper none
