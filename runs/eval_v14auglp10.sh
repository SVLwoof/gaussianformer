...
#SBATCH -c 8
#SBATCH --mem=48GB
#SBATCH --output=runs/eval_v14auglp10_%j.out
#SBATCH --job-name=eval_v14auglp10
#SBATCH --gres=gg:g4:1
#SBATCH --killable
#SBATCH --requeue
...
CKPT="${CKPT:-checkpoints_v14auglp10/phase2_epoch_1.pt}"
EP="${CKPT:t:r}"
...
uv run --frozen python -m eval_val_full \
  ...
  --out_json "eval_results/v14auglp10_${EP}_n20k_val.json" \
