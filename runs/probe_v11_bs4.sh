...
#SBATCH -c 32
#SBATCH --mem=128GB
#SBATCH --output=runs/probe_v11_bs4_%j.out
#SBATCH --job-name=probe_v11_bs4
#SBATCH --gres=gg:g4:4
...
SMI_LOG="runs/probe_v11_bs4_${SLURM_JOB_ID}_smi.log"
...
uv run --frozen torchrun --standalone --nproc_per_node=4 -m training.train \
  ...
  --save_dir checkpoints_probe_v11_bs4 \
